...
# Form implementation generated from reading ui file '/home/dane/projects/autodane/autodane/initialoptions/choosefootprint.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.btnAddShortListPort.setObjectName(_fromUtf8("btnAddShortListPort"))
        ...
        self.btnDeleteShortListPort.setObjectName(_fromUtf8("btnDeleteShortListPort"))
        ...
        self.tblPortsShortList.setSelectionMode(QtGui.QAbstractItemView.SingleSelection)
        self.tblPortsShortList.setSelectionBehavior(QtGui.QAbstractItemView.SelectRows)
        ...
        self.btnDeleteFullListPort.setObjectName(_fromUtf8("btnDeleteFullListPort"))
        self.gridLayout_19.addWidget(self.btnDeleteFullListPort, 1, 1, 1, 1)
        self.tblPortsFullList = QtGui.QTableWidget(self.groupBox_10)
        self.tblPortsFullList.setSelectionMode(QtGui.QAbstractItemView.SingleSelection)
        self.tblPortsFullList.setSelectionBehavior(QtGui.QAbstractItemView.SelectRows)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.tabWidget_3.setTabText(self.tabWidget_3.indexOf(self.tab_14), _translate("Dialog", "New Domain Creds", None))
        ...
        self.label_23.setText(_translate("Dialog", "<html><head/><body><p>These settings allow you to manage the tool\'s plugins. Changes here are applied globally rather than per footprint</p><p>Also, the defaults will work in most cases, and will rarely need to be changed.</p><p><br/>The different options available are as follows:</p><p><span style=\" font-weight:600; text-decoration: underline;\">Ports</span></p><p>This lets you choose which ports will be scanned in different circumstances. </p><p>The short-list of ports is used to quickly check for hosts in a range. </p><p>If any open ports are found, the entire range is then checked for the full list of ports</p><p><span style=\" font-weight:600; text-decoration: underline;\">Tasks</span></p><p>Lists the different plugins available, grouped by category</p><p><span style=\" font-weight:600; text-decoration: underline;\">Trigger Descriptions</span></p><p>Lists the various triggers that are available, along with how many events are bound to them</p><p><span style=\" font-weight:600; text-decoration: underline;\">Events</span></p><p>Lists the plugins that are run when different events are triggered</p></body></html>", None))
        self.tabWidget_2.setTabText(self.tabWidget_2.indexOf(self.tab_16), _translate("Dialog", "Summary", None))
        self.groupBox_9.setTitle(_translate("Dialog", "Short List", None))
        self.btnAddShortListPort.setText(_translate("Dialog", "Add", None))
        self.btnDeleteShortListPort.setText(_translate("Dialog", "Delete", None))
        item = self.tblPortsShortList.horizontalHeaderItem(0)
        item.setText(_translate("Dialog", "Port", None))
        self.groupBox_10.setTitle(_translate("Dialog", "Full List", None))
        self.btnAddFullListPort.setText(_translate("Dialog", "Add", None))
        self.btnDeleteFullListPort.setText(_translate("Dialog", "Delete", None))
        item = self.tblPortsFullList.horizontalHeaderItem(0)
        item.setText(_translate("Dialog", "Port", None))
        self.tabWidget_2.setTabText(self.tabWidget_2.indexOf(self.tab_15), _translate("Dialog", "Ports", None))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), _translate("Dialog", "Base Settings", None))
